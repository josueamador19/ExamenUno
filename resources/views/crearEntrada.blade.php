                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <form">
                                        ...
                                        <input type="text" name="apellido" class="form-control" placeholder="Introduce el apellido">
                                        <label for="">Tel&eacute;fono</label>
                                        <input type="text" name="telefono" class="form-control" placeholder="Introduce el telefono">
                                        
                                        
                                        
                                        <button type="submit" class="btn btn-primary">Guardar</button>
                                        <a href="{{route('regresar')}}" class="btn btn-info">Regresar</a>
